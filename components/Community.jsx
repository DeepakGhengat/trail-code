    ...
    <Fade>
      <section className="my-[70px] mt-[100px] flex flex-col items-center">
        ...
        <div className="flex space-x-[70px] mt-[40px]">
          <a href="https://discord.com/invite/fRc6XxhfBq" target="_blank" className="flex items-center space-x-[10px]" rel="noreferrer">
          ...
          <a href="https://defiedge.substack.com/" target="_blank" className="flex items-center space-x-[10px]" rel="noreferrer">

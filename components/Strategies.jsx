    ...
    <Fade>
      <section className="sm:mt-[150px] mt-[100px]">
        <div className="relative w-screen">
          <div className="absolute left-0 -mt-[200px]  -ml-[550px]">
            <Image
              type="image"
              className="w-[111px] h-[31px]"
              alt=""
              src={strategygradient}
            />
          </div>
        </div>
        <div className="text-center mb-[50px] relative z-10">
          ...
          <p className="text-textgray  text-[16px] sm:text-[18px] mt-[20px] sm:mt-[25px]">
        ...
        <div className="grid sm:grid-cols-3 grid-cols-1 gap-[25px] ">
          <div className="bg-opacity-5 bg-white ring-2 ring-white/10 bg-clip-padding backdrop-filter backdrop-blur-xl p-[32px]">
            ...
            <div className="mt-[30px]">
              ...
              <span className="justify-between flex mt-[20px]">

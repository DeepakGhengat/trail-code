            ...
            <div className="text-center md:w-1/2   md:text-left">
              ...
              <Fade delay={30} duration={3000}>
                <p className="text-16px mt-[12px] font-medium leading-[28px] text-gray-400">
                  ...
                  AMMs to optimize capital efficiency. Coupled with our
                  signature Automated Liquidity Optimization (ALO) and exclusive
                  advanced liquidity management features, we provide a dynamic
                  edge in the ever-evolving DeFi landscape.
                </p>
              </Fade>
            </div>
            {isClient && (
